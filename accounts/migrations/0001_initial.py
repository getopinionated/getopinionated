...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_customuser', (
            ...
            ('member_since', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 23, 0, 0))),
            ('profile_views', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('daily_digest', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('weekly_digest', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('send_new', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('send_voting', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('send_finished', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('send_favorites_and_voted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('accounts', ['CustomUser'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('accounts_customuser')
