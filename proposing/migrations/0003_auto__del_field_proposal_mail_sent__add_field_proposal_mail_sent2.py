...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Proposal.mail_sent2'
        db.add_column('proposing_proposal', 'mail_sent2',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Proposal.mail_sent2'
        db.delete_column('proposing_proposal', 'mail_sent2')
    ...
    models = {
        'accounts.customuser': {
            ...
            'member_since': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 22, 0, 0)'}),
        ...
        'proposing.proposal': {
            ...
            'mail_sent2': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'motivation': ('django.db.models.fields.TextField', [], {}),
